      ...
      <div class="w-full flex justify-center py-4">
        ...
        >
          <div v-for="value in intro?.manager" :key="value">
              <img class="max-w-[225px]" :src="value.img" alt="">
    ...
    <section class="py-4">
      ...
      <div class="w-full flex justify-center py-4">
        ...
        >
          <div class="" v-for="value in listHistory" :key="value">
            <div class="w-full flex justify-center items-center">
              <div :class="`w-auto md:w-full h-[1px] bg-[#DC0F0F]`"></div>
              <span
      ...
      <div class="w-full flex justify-center py-4">
        ...
        >
            ...
            <div class="grid lg:grid-cols-5 grid-cols-1 gap-4 py-4">
          ...
          >
            <Slide v-for="(value, index) in comment" :key="index">
              ...
              >
                <img
                  :src="value.url"
                  class="max-h-[232px] max-w-[295px] mb-3"
                  alt="no-img"
                />
                <div
